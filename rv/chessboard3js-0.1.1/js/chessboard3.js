        ...
        //                   fnWhite);
            ...
            */
            ...
            function buildPieceMesh(square, piece) {
                ...
                meshPata1.position.z = coords.z-6;
                meshPata2.position.x = coords.x+legOffset;
                meshPata2.position.z = coords.z-6;

                if (color === 'w') {
                    mesh.rotation.y = Math.PI;
                    meshPata1.rotation.y = Math.PI;
            ...
            function updateDraggedPiece(mouse_x, mouse_y) {
                console.log('camarahijodetuputamadre');
